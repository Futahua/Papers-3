...
describe('windowHelperFactory composition', () => {
  ...
  it('exported surface is capability methods plus start/stop/isReady and the session revision only', () => {
    ...
    expect(surface).toEqual([
      'activate', 'apply', 'cloak', 'cloakMany', 'close', 'hover', 'isReady', 'list', 'livePreview', 'minimize', 'observe', 'placeAdopted', 'restore', 'revision', 'start', 'stop', 'thumbnail', 'toggle', 'uncloak', 'uncloakMany',
    ]);
