...
|---|---|---|---|
| Hermes Agent | 0.16.0 (2026.6.5) | `hermes acp` (Agent Client Protocol over stdio) | Never vendored; configuration never modified; sessions remain in the user's Hermes home |
